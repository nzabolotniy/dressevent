...
<div class="page_meta clear">
    ...
    <div class="heading">
        <h3><a href="<?php if(function_exists('get_blogurl')) { get_blogurl(); } ?>">На главную</a></h3>
    </div>
...
<?php if ( have_posts() ) : ?>
    ...
    <div <?php post_class('post_single clear'); ?> id="post-<?php the_ID(); ?>">
        ...
        <div class="post_list_meta">
            ...
            <p class="post_comms"><?php comments_popup_link(__('Ваш отзыв'), __('1 отзыв'), __('Отзывов (%)'), '', __('Обсуждение закрыто') ); ?></p>
